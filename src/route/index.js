...
Playlist.makeMix(
  Playlist.create(
    'Совместный альбом',
    '/svg/spotify-search.svg',
  ),
)

const playlist2 = Playlist.create('Інь Ян', '/svg/627.svg')
playlist2.tracks = [...Track.getList().slice(3, 5)]
playlist2.amount = playlist2.tracks.length

Playlist.create('Мой плейлист №1', '/svg/music.svg')
...
router.get('/spotify-playlist', function (req, res) {
  ...
  if (!playlist) {
    return res.render('alert', {
      ...
      data: {
        message: 'Ошибка',
        info: 'Такого плейлиста не найдено',
        link: `/`,
      },
    })
  }
